                        ...
                        <div class="post_detail_header">
                          ...
                          <div class="button_gap blue-button" onclick="download_function()" >
                           <div class="output">
                                ...
                                <?php $get_id_page=$_GET['id']; ?>

                                <div class="edit_software"><a href="update.php?id=<?php echo $get_id_page; ?>">Edit</a></div>
                        ...
                        <div class="download-button-mobi blue-button" onclick="download_function()" >
                          ...
                          <div class="tabs">
                            ...
                            <h2>Feature</h2>
                                ...
                                <div class="fect_container4">
                                  <div class="feat_para4_head feat_head">
                                    <?php echo $description_tab_post->getpara4_heading(); ?>
                                  </div>
                                  <div class="feat_para4_desc feat_desc">
...
*.night-mode  .edit_software a{
  box-shadow: 0 0px 2px rgba(255, 255, 255, 0.3), 0 1px 1px rgba(255, 255, 255, 0.22);
