...
class change_tab{
	...
	public function __construct($com,$id){
		...
		$this->para1_heading=isset($change_tab['para1_heading']) ? $change_tab['para1_heading'] : "" ;
		$this->para1_list_number=isset($change_tab['para1_list_number']) ? $change_tab['para1_list_number']:"";
		$this->para2_heading=isset($change_tab['para2_heading']) ? $change_tab['para2_heading']:"";
		$this->para2_list_number=isset($change_tab['para2_list_number']) ? $change_tab['para2_list_number']:"";
		$this->para3_heading=isset($change_tab['para3_heading']) ? $change_tab['para3_heading']:"";
		$this->para3_list_number=isset($change_tab['para3_list_number']) ? $change_tab['para3_list_number']:"";
}
